...
exports.INQUIRY_RECIPIENT_EMAIL = email_1.MAIN_EMAIL;
...
async function sendInquiryEmail(payload) {
    ...
    try {
        ...
        const from = fromUser || process.env.EMAIL_USER || email_1.MAIN_EMAIL;
...
function buildSampleRequestEmailHtml(payload) {
...
function buildInquiryRecipients(envValue) {
    ...
    const base = raw
        ...
        : [exports.INQUIRY_RECIPIENT_EMAIL];
    const seen = new Set();
